import { json, redirect, useLoaderData, Outlet } from 'remix'
...
export default function TransactionsList() {
  ...
  const tabs = [
    { name: 'Semua', href: '#', count: total, current: true },
    {
    ...
    { name: 'Terverifikasi', href: '#', count: verified, current: false },
    { name: 'Ditolak', href: '#', count: rejected, current: false },
  ]

  return (
    <main className="bg-white shadow sm:rounded-lg max-w-7xl mx-auto sm:px-6 lg:px-8 py-6">
