      ...
      item = (
        <>
          <span className="h-9 flex items-center">
            <span className="relative w-8 h-8 flex items-center justify-center bg-indigo-600 rounded-full group-hover:bg-indigo-800">
      ...
      item = (
        <>
          <span className="h-9 flex items-center" aria-hidden="true">
            <span className="relative w-8 h-8 flex items-center justify-center bg-white border-2 border-indigo-600 rounded-full">
